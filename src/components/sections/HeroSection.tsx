        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h1 className="text-4xl md:text-6xl font-bold animate-slide-up">
                  <span className="gradient-text animate-pulse-glow">Ricardo Vallejo</span>
                  <br />
                  Full-Stack Developer
                </h1>
              </div>

              <p className="text-xl text-muted-foreground max-w-2xl animate-slide-up-delay-1">
          ...
          <ScrollAnimationWrapper animation="slide-in-right" className="flex justify-center lg:justify-end">
            <div className="relative">
              <InteractiveCodeScreen className="w-full max-w-lg h-96 transform hover:scale-105 transition-transform duration-300" />

              <div className="absolute -top-4 -left-4 w-8 h-8 bg-primary rounded-full animate-pulse opacity-60"></div>
              <div className="absolute -bottom-4 -right-4 w-6 h-6 bg-accent rounded-full animate-pulse opacity-60" style={{ animationDelay: '1s' }}></div>
              <div className="absolute top-1/2 -right-8 w-4 h-4 bg-code-keyword rounded-full animate-pulse opacity-60" style={{ animationDelay: '0.5s' }}></div>
            </div>
          </ScrollAnimationWrapper>
        </div>
      </div>
